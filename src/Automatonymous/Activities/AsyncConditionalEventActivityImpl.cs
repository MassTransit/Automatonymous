...
namespace Automatonymous.Activities
{
    ...
    public class AsyncConditionalEventActivityImpl<TInstance, TData> :
        AsyncEventActivity<TInstance>
    {
        ...
        public AsyncConditionalEventActivityImpl(Event @event, AsyncActivity<TInstance> activity,
        ...
        public void Execute<TEventData>(TInstance instance, TEventData value)
        {
            ...
            if (_filterExpression(dataValue) == false)
                return;
        ...
        static TData GetDataValue<TEventData>(TEventData value)
        {
            if (!(value is TData))
            {
