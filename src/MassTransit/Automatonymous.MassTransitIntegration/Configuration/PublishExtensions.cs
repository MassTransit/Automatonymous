...
namespace Automatonymous
{
    ...
    public static class PublishExtensions
    {
        ...
        {
            return source.Add(new PublishActivity<TInstance, TMessage>(x => message, x => { }));
        }

        public static EventActivityBinder<TInstance> Publish<TInstance, TMessage>(
            this EventActivityBinder<TInstance> source,
            TMessage message, Action<IPublishContext<TMessage>> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TMessage : class
        {
            return source.Add(new PublishActivity<TInstance, TMessage>(i => message, contextCallback));
        }

        public static EventActivityBinder<TInstance> Publish<TInstance, TMessage>(
            this EventActivityBinder<TInstance> source,
            Func<TInstance, TMessage> messageFactory)
            where TInstance : class, SagaStateMachineInstance
            where TMessage : class
        {
            return source.Add(new PublishActivity<TInstance, TMessage>(messageFactory, x => { }));
        }

        public static EventActivityBinder<TInstance> Publish<TInstance, TMessage>(
            this EventActivityBinder<TInstance> source,
            Func<TInstance, TMessage> messageFactory, Action<IPublishContext<TMessage>> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TMessage : class
        {
        ...
        {
            return
                source.Add(new PublishActivity<TInstance, TData, TMessage>((i, d) => message, contextCallback));
        }
        ...
        {
            return
                source.Add(new PublishActivity<TInstance, TData, TMessage>((i, d) => messageFactory(i), x => { }));
        }
        ...
        {
            return
                source.Add(new PublishActivity<TInstance, TData, TMessage>((i, d) => messageFactory(i),
                    contextCallback));
        }
        ...
        public static EventActivityBinder<TInstance, TData> Publish<TInstance, TData, TMessage>(
            ...
            where TMessage : class
        {
            return source.Add(new PublishActivity<TInstance, TData, TMessage>(messageFactory, x => { }));
        }
            ...
            where TMessage : class
        {
            ...
            return source.Add(new PublishActivity<TInstance, TData, TMessage>(factory, contextCallback));
        }
    }
}